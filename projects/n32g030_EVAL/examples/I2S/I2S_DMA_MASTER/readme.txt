...
3. Instructions for use
	...
	4. Log printing: main mode DEMO board PA9(TX), baud rate: 115200
	...
	2. After the master mode DEMO board and slave mode DEMO board PA4, PA5, PA7 are connected, 
       ...
       First press and hold the reset button of the master mode DEMO board, 
	   then press the reset button of the slave mode DEMO board,
