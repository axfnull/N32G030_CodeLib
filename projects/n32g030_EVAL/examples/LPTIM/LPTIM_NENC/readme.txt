...
3. Instructions for use
     ...
     Instructions:
         1. Open the debug mode after compiling, connect PB0 and PA0, PB1 and PA1, and add the variable NencCNT to the watch window
         2. After the program runs, PB0 PB1 outputs 20 pulse cycles, and NencCNT is equal to 20
